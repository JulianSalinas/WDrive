...
//        api.pasteFile();
        ...
        System.out.println(api.createFile("file1.txt", "contenido"));
        System.out.println(api.createFile("file1.txt", "contenido"));


        System.out.println(api.createDir("doc"));
        System.out.println(api.createDir("doc"));


        System.out.println(api.copyFile("file1.txt"));
        System.out.println(api.pasteFile());
